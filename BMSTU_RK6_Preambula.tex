...
\usepackage{vmargin}
\setpapersize{A4}
\setmarginsrb{3cm}{1.3cm}{1cm}{2cm}{0pt}{0mm}{0pt}{13mm} % {левое поле}{верхнее поле}{правое поле}{нижнее поле}{колонтитулы}{колонтитулы}{колонтитулы}{номер страницы}
...
%Интервал в itemize
\setlist[itemize,1]{leftmargin=0pt,itemindent=(\parindent+0.66\labelwidth),topsep=0pt,itemsep=0pt,parsep=0pt,partopsep=0pt}
...
%Делаем нумерацию страниц справа сверху
\usepackage{fancyhdr}
\pagestyle{fancy}
\fancyhf{}
\fancyhead[R]{\thepage}
...
%Переопределение первых страниц глав
...
\renewcommand{\cfttoctitlefont}{\hfil\large\bfseries\MakeUppercase\hfil} %% В доках написано, что
